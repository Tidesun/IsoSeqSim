...
def main(args):
	...
	sys.stdout.flush()
	generate_expr_matrix(args.input,args.expression,args.nb_n,args.nb_p,args.output)
	sys.stdout.write("Finish analysis: " + time.strftime("%a,%d %b %Y %H:%M:%S") + "\n")
	sys.stdout.flush()

def generate_expr_matrix(input_gpd_fl,expression_fl,nb_r,nb_p,output_expr_mtx):
	# parse gpd file
	gpd_dict = {}
